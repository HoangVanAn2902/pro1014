<nav id="sidebar">
    <div class="sidebar-header">
        <a href="<?= $SITE_URL ?>/trang-chinh/">
            <img src="<?= $CONTENT_URL ?>/images/items/logo.png" alt="logo" class="img-fluid logo">
        </a>
    </div>
    <ul class="list-unstyled components text-secondary">
        <li>
            <a href="<?= $SITE_URL ?>/trang-chinh/"><i class="fas fa-store"></i>Trở lại web</a>
        </li>
        <li>
            <a href="<?= $ADMIN_URL ?>/trang-chinh/"><i class="fas fa-home"></i>Tổng Quát</a>
        </li>
        <!-- Danh mục -->
        <li>
